...
class GoogleMapsService:
    ...
    AIRPORT_COORDS = {
        ...
        "LIS": "38.6813,-9.2267",     # Lisbon Humberto Delgado
    ...
    async def nearby_search(
        location: str,
        radius_m: int,
        keyword: str = "tourist_attraction",
        max_results: int = 20
    ) -> Optional[list]:
        """
        Search for places near a location using Places API Nearby Search
        ...
        try:
            params = {
                ...
                "radius": radius_m,
                "keyword": keyword,
                "rankby": "prominence",  # Sort by popularity/rating
